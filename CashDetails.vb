    ...
    Private Sub CashDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case TargetForm1
            Case Is = "AllCustsDebts"
                ...
                Cryp.Load(IO.Path.Combine(Application.StartupPath, "AllCustsDebtsRP.rpt"))
            ...
            Case Is = "AllVendsDebts"
                ...
                Cryp.Load(IO.Path.Combine(Application.StartupPath, "AllVendsDebtsRP.rpt"))
            ...
            Case Is = "AllCustPaid"
                ...
                Cryp.Load(IO.Path.Combine(Application.StartupPath, "CustInstalls.rpt"))
            ...
            Case Is = "AllVendPaid"
                ...
                Cryp.Load(IO.Path.Combine(Application.StartupPath, "VendInstalls.rpt"))
