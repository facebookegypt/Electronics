...
Public Class AllVendsDebtsRP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_And_Purchases.AllVendsDebtsRP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllVendsDebtsRP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllVendsDebtsRP = New AllVendsDebtsRP()
        rpt.Site = Me.Site
        Return rpt
    End Function
