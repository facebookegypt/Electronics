...
Public Class CustCashIns
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_And_Purchases.CustCashIns.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustCashIns
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustCashIns = New CustCashIns()
        rpt.Site = Me.Site
        Return rpt
    End Function
