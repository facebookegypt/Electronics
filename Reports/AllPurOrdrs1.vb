...
Public Class AllPurOrdrs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_And_Purchases.AllPurOrdrs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllPurOrdrs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllPurOrdrs = New AllPurOrdrs()
        rpt.Site = Me.Site
        Return rpt
    End Function
