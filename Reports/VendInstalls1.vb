...
Public Class VendInstalls
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_And_Purchases.VendInstalls.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVendInstalls
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VendInstalls = New VendInstalls()
        rpt.Site = Me.Site
        Return rpt
    End Function
