...
Public Class CustInstalls
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_And_Purchases.CustInstalls.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustInstalls
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustInstalls = New CustInstalls()
        rpt.Site = Me.Site
        Return rpt
    End Function
