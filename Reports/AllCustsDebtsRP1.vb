...
Public Class AllCustsDebtsRP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_And_Purchases.AllCustsDebtsRP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllCustsDebtsRP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllCustsDebtsRP = New AllCustsDebtsRP()
        rpt.Site = Me.Site
        Return rpt
    End Function
